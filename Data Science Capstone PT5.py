...
for index,site in launch_sites_df.iterrows():
    ...
    print('cordinate :',coord)
    circle= folium.Circle(coord, color='#e35400', radius=50, fill=True).add_child(folium.Popup(site['Launch Site'])).add_to(circle)
...
coordinates = [[28.56342, -80.57674], [28.57561, -80.58444]]
launch_site_lat = coordinates[0][0]
launch_site_lon = coordinates[0][1]
railway_lat = coordinates[1][0]
railway_lon = coordinates[1][0]
...
coordinates = [[28.56342, -80.57674], [28.56342, -80.56756]]
launch_site_lat = coordinates[0][0]
launch_site_lon = coordinates[0][1]
coastline_lat = coordinates[1][0]
coastline_lon = coordinates[1][0]
distance_coastline = calculate_distance(launch_site_lat, launch_site_lon, coastline_lat, coastline_lon)
